...
- **Module 1 — Meeting Rooms** (`mr_*`): present here at portlet depth, so the home
  dashboard is a genuinely multi-module grid. The full booking flow is the subject of
  `WOROOD-HUB-Technical-Design.md`.
