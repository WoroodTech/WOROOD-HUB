...
export const qk = {
  ...
  tasks: (filters: string) => ['tasks', 'list', filters] as const,
  task: (id: string) => ['tasks', 'item', id] as const,
  taskDepartments: ['tasks', 'departments'] as const,
  taskPeople: (departmentId: string) => ['tasks', 'people', departmentId] as const,
